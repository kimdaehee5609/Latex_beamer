...
%			\pgfpagesuselayout{resize to}[a4paper,border shrink=5mm]
			\pgfpagesuselayout{resize to}[a5paper,border shrink=5mm]
...
\begin{frame}[t,squeeze,allowframebreaks]{block}
...
\setbeamercolor{postit}{fg=black,bg=lightgray!30}
